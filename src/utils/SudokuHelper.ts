...
import { SelectedCell } from "../reducers";

export class SudokuHelper {
    public static isCellHighlighted(cell: CellCoordinates, selectedCell: SelectedCell): boolean {
        if (selectedCell) {
            // Same group
    ...
    private static inSameGroupRow(cell: CellCoordinates, selectedCell: CellCoordinates): boolean {
    ...
    private static inSameGroupCol(cell: CellCoordinates, selectedCell: CellCoordinates): boolean {
    ...
    private static inSameCellRowWithinAGroupRow
        (cell: CellCoordinates, selectedCell: CellCoordinates): boolean {
